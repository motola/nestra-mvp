"""Aqara adapter — normalizes Aqara devices to unified Device model."""
...
class AqaraAdapter:
    ...
    async def fetch_devices(
        ...
        *,
        ...
        """Fetch Aqara devices and normalize to Device objects.

        Mock implementation — returns empty list. Real implementation
        would call Aqara API and parse devices.
        """
        # TODO: Call Aqara API, parse devices, build Device objects with create_device_data()
        return []

    async def fetch_state(self, device: Device) -> Device:
        """Refresh device state from Aqara API.

        Mock implementation — returns device unchanged.
        """
        # TODO: Call Aqara API to get device state
        return Device(
            id=device.id,
    ...
    async def execute(self, device: Device, command: str, params: dict[str, object]) -> bool:
        """Execute control command on Aqara device.
