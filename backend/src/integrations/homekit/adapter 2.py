"""Apple HomeKit adapter — normalizes Apple HomeKit devices to unified Device model."""
...
class HomekitAdapter:
    """Adapter for Apple HomeKit devices."""
    ...
    async def fetch_devices(
        ...
        *,
        ...
        """Fetch Apple HomeKit devices and normalize to Device objects.

        Mock implementation — returns empty list. Real implementation
        would call Apple HomeKit API and parse devices.
        """
        # TODO: Call Apple HomeKit API, parse devices, build Device objects
        return []

    async def fetch_state(self, device: Device) -> Device:
        """Refresh device state from Apple HomeKit API.

        Mock implementation — returns device unchanged.
        """
        # TODO: Call Apple HomeKit API to get device state
        return Device(
            id=device.id,
    ...
    async def execute(self, device: Device, command: str, params: dict[str, object]) -> bool:
        """Execute control command on Apple HomeKit device.
