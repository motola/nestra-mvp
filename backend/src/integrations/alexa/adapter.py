"""Alexa adapter — normalizes Alexa devices to unified Device model."""
...
class AlexaAdapter:
    ...
    async def fetch_devices(
        ...
        *,
        ...
        """Fetch Alexa devices and normalize to Device objects.

        Mock implementation — returns empty list. Real implementation
        would call Alexa API and parse devices.
        """
        # TODO: Call Alexa API, parse devices, build Device objects with create_device_data()
        return []

    async def fetch_state(self, device: Device) -> Device:
        """Refresh device state from Alexa API.

        Mock implementation — returns device unchanged.
        """
        # TODO: Call Alexa API to get device state
        return Device(
            id=device.id,
    ...
    async def execute(self, device: Device, command: str, params: dict[str, object]) -> bool:
        """Execute control command on Alexa device.
