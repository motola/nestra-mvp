"""Lutron adapter — normalizes Lutron devices to unified Device model."""
...
class LutronAdapter:
    ...
    async def fetch_devices(
        ...
        *,
        ...
        """Fetch Lutron devices and normalize to Device objects.

        Mock implementation — returns empty list. Real implementation
        would call Lutron API and parse devices.
        """
        # TODO: Call Lutron API, parse devices, build Device objects with create_device_data()
        return []

    async def fetch_state(self, device: Device) -> Device:
        """Refresh device state from Lutron API.

        Mock implementation — returns device unchanged.
        """
        # TODO: Call Lutron API to get device state
        return Device(
            id=device.id,
    ...
    async def execute(self, device: Device, command: str, params: dict[str, object]) -> bool:
        """Execute control command on Lutron device.
