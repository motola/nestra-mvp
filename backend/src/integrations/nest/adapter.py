"""Nest adapter — normalizes Nest devices to unified Device model."""
...
class NestAdapter:
    ...
    async def fetch_devices(
        ...
        *,
        ...
        """Fetch Nest devices and normalize to Device objects.

        Mock implementation — returns empty list. Real implementation
        would call Nest API and parse devices.
        """
        # TODO: Call Nest API, parse devices, build Device objects with create_device_data()
        return []

    async def fetch_state(self, device: Device) -> Device:
        """Refresh device state from Nest API.

        Mock implementation — returns device unchanged.
        """
        # TODO: Call Nest API to get device state
        return Device(
            id=device.id,
    ...
    async def execute(self, device: Device, command: str, params: dict[str, object]) -> bool:
        """Execute control command on Nest device.
