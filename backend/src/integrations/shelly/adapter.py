...
This module also holds the direct local-network controller (``ShellyController``)
and the Windows Wi-Fi provisioning flow used to onboard new Shelly devices.
"""
...
# ── Provisioning: Windows Wi-Fi onboarding flow ───────────────────────────────
#
# Steps:
