...
class TestBluetoothPairing(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        import integrations.bluetooth.routes as routes
    ...
    def test_pair_device_success(self) -> None:
        ...
        from integrations.bluetooth.routes import pair_device
        from integrations.bluetooth.schemas import BluetoothDeviceIn
    ...
    def test_unpair_device_success(self) -> None:
        ...
        from integrations.bluetooth.routes import pair_device, unpair_device
        from integrations.bluetooth.schemas import BluetoothDeviceIn
    ...
    def test_unpair_nonexistent_device_fails(self) -> None:
        ...
        from integrations.bluetooth.routes import unpair_device
    ...
    def test_list_devices_empty(self) -> None:
        ...
        from integrations.bluetooth.routes import list_devices
    ...
    def test_list_devices_filters_by_property(self) -> None:
        ...
        from integrations.bluetooth.routes import list_devices, pair_device
        from integrations.bluetooth.schemas import BluetoothDeviceIn
...
class TestBluetoothIntegration(unittest.TestCase):
    ...
    def test_full_pairing_workflow(self) -> None:
        ...
        from integrations.bluetooth.routes import list_devices, pair_device, unpair_device
        from integrations.bluetooth.schemas import BluetoothDeviceIn
