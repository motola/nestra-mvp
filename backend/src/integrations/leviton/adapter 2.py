"""Leviton adapter — normalizes Leviton devices to unified Device model."""
...
class LevitonAdapter:
    ...
    async def fetch_devices(
        ...
        *,
        ...
        """Fetch Leviton devices and normalize to Device objects.

        Mock implementation — returns empty list. Real implementation
        would call Leviton API and parse devices.
        """
        # TODO: Call Leviton API, parse devices, build Device objects with create_device_data()
        return []

    async def fetch_state(self, device: Device) -> Device:
        """Refresh device state from Leviton API.

        Mock implementation — returns device unchanged.
        """
        # TODO: Call Leviton API to get device state
        return Device(
            id=device.id,
    ...
    async def execute(self, device: Device, command: str, params: dict[str, object]) -> bool:
        """Execute control command on Leviton device.
