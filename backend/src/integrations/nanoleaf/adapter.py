"""Nanoleaf adapter — normalizes Nanoleaf devices to unified Device model."""
...
class NanoleafAdapter:
    ...
    async def fetch_devices(
        ...
        *,
        ...
        """Fetch Nanoleaf devices and normalize to Device objects.

        Mock implementation — returns empty list. Real implementation
        would call Nanoleaf API and parse devices.
        """
        # TODO: Call Nanoleaf API, parse devices, build Device objects with create_device_data()
        return []

    async def fetch_state(self, device: Device) -> Device:
        """Refresh device state from Nanoleaf API.

        Mock implementation — returns device unchanged.
        """
        # TODO: Call Nanoleaf API to get device state
        return Device(
            id=device.id,
    ...
    async def execute(self, device: Device, command: str, params: dict[str, object]) -> bool:
        """Execute control command on Nanoleaf device.
