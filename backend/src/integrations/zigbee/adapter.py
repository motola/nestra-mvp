"""Zigbee adapter — normalizes Zigbee devices to unified Device model."""
...
class ZigbeeAdapter:
    ...
    async def fetch_devices(
        ...
        *,
        ...
        """Fetch Zigbee devices and normalize to Device objects.

        Mock implementation — returns empty list. Real implementation
        would call Zigbee API and parse devices.
        """
        # TODO: Call Zigbee API, parse devices, build Device objects with create_device_data()
        return []

    async def fetch_state(self, device: Device) -> Device:
        """Refresh device state from Zigbee API.

        Mock implementation — returns device unchanged.
        """
        # TODO: Call Zigbee API to get device state
        return Device(
            id=device.id,
    ...
    async def execute(self, device: Device, command: str, params: dict[str, object]) -> bool:
        """Execute control command on Zigbee device.
