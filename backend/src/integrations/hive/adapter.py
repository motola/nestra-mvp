"""Hive adapter — normalizes Hive devices to unified Device model."""
...
class HiveAdapter:
    ...
    async def fetch_devices(
        ...
        *,
        ...
        """Fetch Hive devices and normalize to Device objects.

        Mock implementation — returns empty list. Real implementation
        would call Hive API and parse devices.
        """
        # TODO: Call Hive API, parse devices, build Device objects with create_device_data()
        return []

    async def fetch_state(self, device: Device) -> Device:
        """Refresh device state from Hive API.

        Mock implementation — returns device unchanged.
        """
        # TODO: Call Hive API to get device state
        return Device(
            id=device.id,
    ...
    async def execute(self, device: Device, command: str, params: dict[str, object]) -> bool:
        """Execute control command on Hive device.
