"""Inovelli adapter — normalizes Inovelli devices to unified Device model."""
...
class InovelliAdapter:
    """Adapter for Inovelli devices."""
    ...
    async def fetch_devices(
        ...
        *,
        ...
        """Fetch Inovelli devices and normalize to Device objects.

        Mock implementation — returns empty list. Real implementation
        would call Inovelli API and parse devices.
        """
        # TODO: Call Inovelli API, parse devices, build Device objects with create_device_data()
        return []

    async def fetch_state(self, device: Device) -> Device:
        """Refresh device state from Inovelli API.

        Mock implementation — returns device unchanged.
        """
        # TODO: Call Inovelli API to get device state
        return Device(
            id=device.id,
    ...
    async def execute(self, device: Device, command: str, params: dict[str, object]) -> bool:
        """Execute control command on Inovelli device.
