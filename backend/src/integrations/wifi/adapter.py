"""WiFi adapter — normalizes WiFi devices to unified Device model."""
...
class WifiAdapter:
    ...
    async def fetch_devices(
        ...
        *,
        ...
        """Fetch WiFi devices and normalize to Device objects.

        Mock implementation — returns empty list. Real implementation
        would call WiFi API and parse devices.
        """
        # TODO: Call WiFi API, parse devices, build Device objects with create_device_data()
        return []

    async def fetch_state(self, device: Device) -> Device:
        """Refresh device state from WiFi API.

        Mock implementation — returns device unchanged.
        """
        # TODO: Call WiFi API to get device state
        return Device(
            id=device.id,
    ...
    async def execute(self, device: Device, command: str, params: dict[str, object]) -> bool:
        """Execute control command on WiFi device.
