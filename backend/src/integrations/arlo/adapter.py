"""Arlo adapter — normalizes Arlo devices to unified Device model."""
...
class ArloAdapter:
    ...
    async def fetch_devices(
        ...
        *,
        ...
        """Fetch Arlo devices and normalize to Device objects.

        Mock implementation — returns empty list. Real implementation
        would call Arlo API and parse devices.
        """
        # TODO: Call Arlo API, parse devices, build Device objects with create_device_data()
        return []

    async def fetch_state(self, device: Device) -> Device:
        """Refresh device state from Arlo API.

        Mock implementation — returns device unchanged.
        """
        # TODO: Call Arlo API to get device state
        return Device(
            id=device.id,
    ...
    async def execute(self, device: Device, command: str, params: dict[str, object]) -> bool:
        """Execute control command on Arlo device.
