...
export default function MaintenancePage() {
  ...
  function handleNotify() {
    setNotified(true);
    toast.success(
      "You're on the waitlist! We'll notify you when Maintenance launches.",
    );
  }
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center py-12 max-w-md mx-auto text-center">
          ...
          <p className="font-body font-light text-sm text-text-2 leading-relaxed mb-8">
            Smart maintenance management that uses your IoT sensor data to
            predict failures before they happen — saving you emergency callout
            costs.
          </p>
