...
const PERIOD_STATS: Record<
  Period,
  { total: string; cost: string; change: string; positive: boolean }
> = {
        ...
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className="font-body font-light text-sm text-text-3 mt-1">
              Portfolio energy consumption analytics
            </p>
          </div>
          {/* Period toggle */}
                  ...
                  return (
                    <div key={p.id} className="flex items-center gap-3">
                      <div
                        ...
                        style={{
                          background: PROPERTY_BREAKDOWN[i]?.color ?? "#d4c9b5",
                        }}
                      />
                        ...
                        <div className="mt-1 h-1 bg-surface-2 rounded-full overflow-hidden">
                          <div
                            ...
                            style={{
                              width: `${share.value}%`,
                              background:
                                PROPERTY_BREAKDOWN[i]?.color ?? "#d4c9b5",
                            }}
                          />
                        </div>
                      </div>
